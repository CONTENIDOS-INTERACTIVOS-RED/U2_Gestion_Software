        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad 2 de "Gestión de Software" aborda la gestión de la configuración como proceso clave para mantener la calidad, trazabilidad y estabilidad del software. Se enfoca en la gestión de cambios, definición de líneas base y el uso de herramientas como Jenkins en integración y entrega continua (CI/CD). Se estudian tipos de cambios, herramientas como Jira y Git, criterios para establecer líneas base, su mantenimiento, y la automatización con pipelines. Al final, los estudiantes podrán gestionar eficazmente cambios y versiones, empleando buenas prácticas y herramientas modernas del desarrollo colaborativo.
